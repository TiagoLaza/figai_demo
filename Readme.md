...
\## You will NEED to run the demo endpoint before all others in other to import the JSON data into the database.
...
\## For improvements, I would add a lot more unit testing, investigate what other properties can be separated as constant values (like availability)
...
\## I would also implement infinite scrolling in the React list, and add better styles or even Material UI with a proper grid like AG Grid.
